...
import { Compare } from '../math-util'
import { Vector2 } from '../vector'

describe('Test Vector2 Class', () => {
  test('Add two Vector2 instance', () => {
    const v1: TPosition2 = [2, 1]
    const v2: TPosition2 = [3, 3]
